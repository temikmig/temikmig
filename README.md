...
_Специализируюсь на разработке масштабируемых корпоративных интерфейсов и современных веб-приложений. Имею опыт работы с крупными проектами: desktop + mobile, workflow, бизнес-логика и адаптивный UI._
...
- React-архитектура и масштабируемые SPA
- Корпоративные системы с workflow и ролями
- Feature-ориентированная архитектура (FSD)
- Производственные интерфейсы (desktop + mobile)
- Бизнес-логика и интеграция с backend
